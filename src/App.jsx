...
const P_SWITCHES = [
  ...
  { id: 295, area: "おばけシネマ", title: "メモリアルレース！おばけぬま" },
  { id: 296, area: "おばけシネマ", title: "やぶれかぶれ！テレサのひみつの通路" },
  { id: 297, area: "おばけシネマ", title: "さかさまのせかい！おばけかいだん" },
  { id: 298, area: "おばけシネマ", title: "てんかいこうげき！のきしたの青コイン" },
  { id: 299, area: "おばけシネマ", title: "そびえたつ！でかいテレサのあたま" },
  { id: 300, area: "おばけシネマ", title: "がんばれ！ちょうせんしゃたち" },
  // ソルティータウン (301-315)
  { id: 301, area: "ソルティータウン", title: "わたしのしっている ソルティータウン" },
  { id: 302, area: "ソルティータウン", title: "ニョロゾで！みずべのすりぬけ" },
  { id: 303, area: "ソルティータウン", title: "ふんいきもさいこう！おんせんしゅうかい" },
  { id: 304, area: "ソルティータウン", title: "ようこそ！ソルティータウンの青コイン" },
  { id: 305, area: "ソルティータウン", title: "とびいれ！こうかいの青コイン" },
  { id: 306, area: "ソルティータウン", title: "よりみち！おおたきへのちかみち" },
  { id: 307, area: "ソルティータウン", title: "うみをわたれ！おきのしまへ" },
  { id: 308, area: "ソルティータウン", title: "わきあいあい！おんせんのたのしみかた" },
  { id: 309, area: "ソルティータウン", title: "ぬれるぞ！ゆけむりの青コイン" },
  { id: 310, area: "ソルティータウン", title: "ピーチビーチへのただしいいきかた" },
  { id: 311, area: "ソルティータウン", title: "さいこうのながめ！ちょうじょうの青コイン" },
  { id: 312, area: "ソルティータウン", title: "ダーッ！チャレンジ！みなとのとびこみだい" },
  { id: 313, area: "ソルティータウン", title: "のぼれのぼれ！ビルのひょうめん" },
  { id: 314, area: "ソルティータウン", title: "いこうよ！ホネホネツイスターへ" },
  { id: 315, area: "ソルティータウン", title: "ひろがる！どこまでもつづく水平線" },
  // アイスビルディング (316-330)
  { id: 316, area: "アイスビルディング", title: "かけあがれ！こおりのビル" },
  { id: 317, area: "アイスビルディング", title: "くだって！こおりのビルのそとがわ" },
  { id: 318, area: "アイスビルディング", title: "よじのぼれ！こおりのカベ" },
  { id: 319, area: "アイスビルディング", title: "にっこり！こおりのビルのなか" },
  { id: 320, area: "アイスビルディング", title: "トゲゾーのさかなつり！？" },
  { id: 321, area: "アイスビルディング", title: "ロゼッタてんもんだいへのちかみち" },
  { id: 322, area: "アイスビルディング", title: "いてつくかぜ！こうやのタイムトライアル" },
  { id: 323, area: "アイスビルディング", title: "まわれ！こおりのかべのそとがわ" },
  { id: 324, area: "アイスビルディング", title: "ぐるっといこう！こおりのひろば" },
  { id: 325, area: "アイスビルディング", title: "しゃきっとしよう！こおりのビルレース" },
  { id: 326, area: "アイスビルディング", title: "かけぬけろ！こおりのビルのなか" },
  { id: 327, area: "アイスビルディング", title: "とびまわれ！ゆきのなかの青コイン" },
  { id: 328, area: "アイスビルディング", title: "ながれにのれ！スケートリンクの青コイン" },
  { id: 329, area: "アイスビルディング", title: "きりひらけ！こおりのかべのうらみち" },
  { id: 330, area: "アイスビルディング", title: "そらのまちへ！こおりのビルのてっぺん" },
  // ロゼッタてんもんだい (331-345)
  { id: 331, area: "ロゼッタてんもんだい", title: "にぎやか！ロゼッタてんもんだいの青コイン" },
  { id: 332, area: "ロゼッタてんもんだい", title: "うちゅうにいちばんちかい！てんもんだいレース" },
  { id: 333, area: "ロゼッタてんもんだい", title: "めざせ！てんもんだいのてっぺん" },
  { id: 334, area: "ロゼッタてんもんだい", title: "きょうかいをこえて！きわどいフライト" },
  { id: 335, area: "ロゼッタてんもんだい", title: "てんもんだいのとびらをひらけ！" },
  { id: 336, area: "ロゼッタてんもんだい", title: "かがやけ！こうやのほしぞらの青コイン" },
  { id: 337, area: "ロゼッタてんもんだい", title: "かけのぼれ！きょだいかいだん" },
  { id: 338, area: "ロゼッタてんもんだい", title: "ほしにねがいを！てんもんだいのかたすみ" },
  { id: 339, area: "ロゼッタてんもんだい", title: "ほしはいつも！みはらしのよいばしょ" },
  { id: 340, area: "ロゼッタてんもんだい", title: "こうやをゆく！スノーモービルのたびじ" },
  { id: 341, area: "ロゼッタてんもんだい", title: "がんばれ！ゆきにうもれないで" },
  { id: 342, area: "ロゼッタてんもんだい", title: "ブリザード！こうやのタイムトライアル" },
  { id: 343, area: "ロゼッタてんもんだい", title: "ふぶきにまけるな！こうやのたいきゅうレース" },
  { id: 344, area: "ロゼッタてんもんだい", title: "ロゼッタてんもんだいのひみつのばしょ" },
  { id: 345, area: "ロゼッタてんもんだい", title: "おいかけろ！こうやのUFO" },
  // ワリオシップ (346-360)
  { id: 346, area: "ワリオシップ", title: "つっぱしれ！きかんしゃかんせいへのみち" },
  { id: 347, area: "ワリオシップ", title: "さらわれた！ワリオシップのきかんしゃ" },
  { id: 348, area: "ワリオシップ", title: "ワリオシップ！かんぜいてきな青コイン" },
  { id: 349, area: "ワリオシップ", title: "スレスレ！デッキのバランスウォーク" },
  { id: 350, area: "ワリオシップ", title: "にげろ！ワリオかんたいのきゅうりょう" },
  { id: 351, area: "ワリオシップ", title: "ハネはさいこう！きかんしゃかんせいアクション" },
  { id: 352, area: "ワリオシップ", title: "かいぞくおうへのちかみち！ワリオシップ" },
  { id: 353, area: "ワリオシップ", title: "かいぞくせん！ひみつのかいろ" },
  { id: 354, area: "ワリオシップ", title: "ちょうせん！ワリオシップレース" },
  { id: 355, area: "ワリオシップ", title: "あぶない！ドカンのかいほびん" },
  { id: 356, area: "ワリオシップ", title: "ワリオかんたい！かんぜんほういさく" },
  { id: 357, area: "ワリオシップ", title: "たかいところもへっちゃら！マストのうえ" },
  { id: 358, area: "ワリオシップ", title: "テク！かんてんでっき" },
  { id: 359, area: "ワリオシップ", title: "かいぞく！ワリオせんちょうのはくりょく" },
  { id: 360, area: "ワリオシップ", title: "マリオカートスタッフもビックリ！5", hard: true },
  // DKスノーマウンテン (361-380)
  { id: 361, area: "DKスノーマウンテン", title: "スノーバレルロール！DKスノーマウンテン" },
  { id: 362, area: "DKスノーマウンテン", title: "かけのぼれ！こうやのがけ" },
  { id: 363, area: "DKスノーマウンテン", title: "スキーのうらみち！いわやまのこみち" },
  { id: 364, area: "DKスノーマウンテン", title: "かけぬけろ！こうやのバレルロールゾーン" },
  { id: 365, area: "DKスノーマウンテン", title: "とびわたれ！こうやのいわのはしら" },
  { id: 366, area: "DKスノーマウンテン", title: "ざんしん！こうやのウォールランロード" },
  { id: 367, area: "DKスノーマウンテン", title: "しゃがんで！スキーのうらみち" },
  { id: 368, area: "DKスノーマウンテン", title: "メモリアルレース！DKスノーマウンテン2" },
  { id: 369, area: "DKスノーマウンテン", title: "メモリアルレース！DKスノーマウンテン3" },
  { id: 370, area: "DKスノーマウンテン", title: "でんでん！こうやのバレルラッシュ" },
  { id: 371, area: "DKスノーマウンテン", title: "かいてん！こうやのハネばたき" },
  { id: 372, area: "DKスノーマウンテン", title: "にっこり！こうやのすべりだい" },
  { id: 373, area: "DKスノーマウンテン", title: "げっかのせつせん！こうやのタイムトライアル" },
  { id: 374, area: "DKスノーマウンテン", title: "かけあがれ！こうやのたかいがけ" },
  { id: 375, area: "DKスノーマウンテン", title: "こうやのふかぶかスノーウォーク" },
  { id: 376, area: "DKスノーマウンテン", title: "うきわをつかんで！こうやのみずうみ" },
  { id: 377, area: "DKスノーマウンテン", title: "メモリアルレース！DKスノーマウンテン1" },
  { id: 378, area: "DKスノーマウンテン", title: "おいかけろ！こうやのゴーカート" },
  { id: 379, area: "DKスノーマウンテン", title: "ゆきのなかで…たびするDKたち" },
  { id: 380, area: "DKスノーマウンテン", title: "こうやのチャンピオン！ハネバットのとびかた" },
  // ハテナしんでん (381-394)
  { id: 381, area: "ハテナしんでん", title: "ハテナしんでんをかけぬけろ！" },
  ...
  { id: 392, area: "ハテナしんでん", title: "もったいない！ひろってダッシュキノコ" },
  { id: 393, area: "ハテナしんでん", title: "めざせ！とくとうせきのてっぺん" },
  { id: 394, area: "ハテナしんでん", title: "すいじょうバイク トレーニングちゅう！" },
];
